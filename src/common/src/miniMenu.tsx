...
function PromiseAllSettled<T extends ((()=>Promise<any>)|Promise<any>|undefined)>(values: T[]) {
    const tr = values.filter(e=> t!==undefined) as ((()=>Promise<any>)|Promise<any>)[]
    const t = PromiseArrayListen(tr)
    Promise.allSettled(t.getData())
    return  t
}
