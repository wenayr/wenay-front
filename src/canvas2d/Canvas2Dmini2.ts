...
// import {DistancePointToLine2D, DistancePointToLine2DBoolean, SearchMaxMinByArray} from "./Canvas2DCommon";
// import {CBar, CBars, ColorString, IBarsImmutable, waitRun} from "wenay-common";
//
//
...
//
//
// type tCanvasMini2 = {show: boolean, name?: string, data: number[], color?: ColorString}
// // export type tICCanvas2DMiniData = {key: tKey, data: tCanvasMini}
//
// type tKey = string|number
// type tSetEventByOnFocus2 = ({x: number, y: number} & tCanvasMini2 & {delta: number, key: tKey, nowData: number})
// interface ICCanvas2DMini2 {
//     html: HTMLDivElement
//     display: CCanvasBase
//     map: Map<tKey, tCanvasMini2>;
//     switchWaterSymbol2: boolean;
//     readonly total:tCanvasMini2
//     setCor(cor: ICContXY): void;
//     setHtml({html, cor, result}: { html: HTMLDivElement, cor?: ICContXY, result?: boolean }): void;
//     RefreshSize(): void;
//     addData2(key: tKey, data: tCanvasMini2): void;
//     getByKey(key: tKey): tCanvasMini2 | undefined;
//     clean(key?: tKey): void;
...
//     setEventByOnFocus(func: (data: (tSetEventByOnFocus2)) => void):    void
// }
//
// class CCanvas2DMini2 implements ICCanvas2DMini2 {
//     html!: HTMLDivElement
//     display!: CCanvasBase
//
//     setCor(cor: ICContXY) {
...
//     }
//
//     map: Map<tKey, tCanvasMini2> = new Map<tKey, tCanvasMini2>()
//
//     RefreshSize() {
//         this.display.RefreshSize()
//     }
...
//     }
//
//     addData2(key: tKey, data: tCanvasMini2) {
//         const {map} = this
//         map.set(key, data)
//     }
//
...
//     }
//
//     switchWaterSymbol2: boolean = true
//    // total: boolean = true
...
//     }
//     readonly total :tCanvasMini2= {show:true, data:[], color:"rgb(0,255,0)"}
//     totalCalculate(){
//         const {map} = this
...
//     _onFocus?: (data: tSetEventByOnFocus2) =>void
//     setEventByOnFocus(func :  ((data: tSetEventByOnFocus2) => void) ){
//         this._onFocus = func
//     }
//
...
//             const arr: (tCanvasMini2 & {delta: number, key:tKey})[] = []
...
//
//
//         const _draw = ({show, data, color}: tCanvasMini2) => {
//             if (show) {
...
//
//
// type tCorX = number | Date
// type tCorEl = number | CBar
// type tCorArr = tCorEl[] | CBars | IBarsImmutable
//
// type tGraphData = {
//     x?: tCorX
//     arr: tCorArr
// }
//
// type tGraphArrayData = {
//
// }
//
// // данные для обработки
//
// // сверка данных по осям
//
// // обработчики данных
//
// // callback на исполнения - перемещения нажатия и прочее
//
// // предварительная сортировки - особенность 2д
//
// //
//
//
