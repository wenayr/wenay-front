...
import {timeLocalToStr_hhmmss, UnArray} from "wenay-common";
import {renderBy, updateBy} from "../../updateBy";
import {staticGetAdd} from "../../../utils/sis";
import {ColDef, ColGroupDef, GridReadyEvent} from "ag-grid-community";
import {StatusRestApi} from "../statusRestApi";
import type {typeLogs} from "../../../../../serverHistoryLoader/src/exchangeBack/minitype";
import {ParametersReact} from "./Parameters2";

type tLogsInput = typeLogs & {id : string, var?: number, time: Date, txt: string}
type tLogsInputR = Required<typeLogs>
type tLogs = tLogsInput & {num: number}
const cashLogs = new Map<string, tLogs[]>()
...
function getLogs(setting: {limit?: number, limitPer: number, varMin?: number}) {
...
export const logsApi = getLogs({limitPer: 500})
...
const pages   = [
    ...
    {name: "connect", key: "StatusRestApi", page: StatusRestApi},
] satisfies ty[]
